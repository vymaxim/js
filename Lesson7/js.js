...
const game = {
  ...
  scoreFoodIncrement() {
    this.foodScore += 1
    document.getElementById('score').innerText = `Счет ${this.foodScore}`
  },

  tickHandler() {
    this.timeIncrement();
    if (this.resetTimer()) return this.barrier.setCoordinates(this.getRandomFreeCoordinates())
